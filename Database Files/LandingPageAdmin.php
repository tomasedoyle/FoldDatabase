...
<body>
    ...
    <div class="main">
		...
		$sql = "select OrderInfo.ItemID, OrderInfo.Instructions,Item.ItemName, OrderInfo.Quantity,OrderInfo.TotalPrice,OrderInfo.TimePlaced from OrderInfo join Item on OrderInfo.ItemID=Item.ItemID";
